...
enum LID_TYPE{AVIA = 1, VELO16, OUST64, AT128, LS_C16, MARSIM}; // {1, 2, 3, 4, 5, 6}
...
// clang-format off
POINT_CLOUD_REGISTER_POINT_STRUCT(at128_ros::Point,
    (float, x, x)
    (float, y, y)
    (float, z, z)
    (float, intensity, intensity)
...
// clang-format off
POINT_CLOUD_REGISTER_POINT_STRUCT(ls_c16_ros::Point,
    (float, x, x)
    (float, y, y)
    (float, z, z)
    (float, intensity, intensity)
